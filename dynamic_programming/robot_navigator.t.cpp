...
class UnitRobotNavigator
    : public ::testing::TestWithParam<UnitRobotNavigator_TestCase> {
   public:
...
INSTANTIATE_TEST_SUITE_P(
    UnitRobotNavigator, UnitRobotNavigator,
    testing::Values(

        UnitRobotNavigator::TestCase{TestName{"grid_1x1"}, Blockers{{false}},
                                     Path{Pos{0, 0}}},
        UnitRobotNavigator::TestCase{TestName{"grid_2x2"},
                                     Blockers{{false, false}, {false, false}},
                                     Path{Pos{0, 0}, Pos{0, 1}, Pos{1, 1}}},
        UnitRobotNavigator::TestCase{
            TestName{"grid_3x3"},
        ...
        UnitRobotNavigator::TestCase{
            TestName{"grid_1x1_obstruction"}, Blockers{{true}}, {}},
...
auto UnitRobotNavigator::getTestName(
